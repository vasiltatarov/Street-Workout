...
namespace StreetWorkout.Data.Migrations
{
    ...
    [Migration("20210814174315_AddPaymentsAndSupplementPayments")]
    partial class AddPaymentsAndSupplementPayments
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StreetWorkout.Data.Models.ChatMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("StreetWorkout.Data.Models.Payment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("StreetWorkout.Data.Models.SupplementPayment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("StreetWorkout.Data.Models.SupplementPayment", b =>
                {
                    b.HasOne("StreetWorkout.Data.Models.Payment", "Payment")
                        .WithMany("SupplementPayments")
                        .HasForeignKey("PaymentId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("StreetWorkout.Data.Models.Supplement", "Supplement")
                        .WithMany("SupplementPayments")
            ...
            modelBuilder.Entity("StreetWorkout.Data.Models.Payment", b =>
                {
                    b.Navigation("SupplementPayments");
                });
